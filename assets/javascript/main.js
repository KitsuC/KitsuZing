...
const app = {
        ...
        if (toatMain) {
            ...
            toast.innerHTML = `
                <div class="toast__item">
                    <span>Chức năng này đang được phát triển, chờ trong thời gian tới nha</span>
        ...
        themeItems.forEach((themeItem, index) => {
            themeItem.onclick = function() {
                if (index == 0) {
                    ...
                    $('.nextsong__option-wrapper-listplay').style.backgroundColor = 'transparent';
                    ...
                    $('.music__option-item.music__option-item--active').style.backgroundColor = "transparent";
                    ...
                    // $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    // $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/rem4.png)';
                    $('.main-music-control').style.backgroundImage = 'none';
                    ...
                    backgroundIndex = 4;
                    $('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/rem7.jpg)';
                    $('.nextsong__fist-item-background--active.nextsong__fist-item').style.backgroundColor = 'var(--waifu-color)'
                    ...
                    $('.main-sidebar').style.backgroundColor = 'rgba(0,0,0,0.01)';
                    $('.header__width-search-input').classList.add('header__width-search-input--white');
                    $('.header__width-search-input').classList.remove('header__width-search-input--dark');
                    $('.music-control__volume-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    $('.music-control__progress-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
    ...
    handleEvents: function () {
        ...
        // KHI BAM VÀO NÚT PHÁT TẤT CẢ OPTION-git
        ...
        playBtnIconsOption1.forEach((item, index) => {
            item.onclick = function() {
                ...
                if(_this.isRandom) {
                    ...
                    $('.nextsong__last-item-end').textContent = 'HẾT BÀI RỒI BẠN ƠIII!';
                } else {
                    _this.renderNexrSong();
                    _this.scrollToActiveNextSong();
                }
